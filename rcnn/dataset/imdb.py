...
class IMDB(object):
    def __init__(self, name, seqs_set, root_path, dataset_path):
        """
        ...
        """
        self.name = name + '_' + seqs_set
        self.seqs_set = seqs_set
    ...
    def image_path_at(self, index):
        ...
        :return: image path
        """
        return self.image_path_from_index(self.seqs_set_index[index])
    ...
    def create_roidb_from_box_list(self, box_list, gt_roidb):
        ...
        :return: roidb: [image_index]['boxes', 'gt_classes', 'gt_overlaps', 'flipped']
        """
        assert len(box_list) == self.num_seqs, 'number of boxes matrix must match number of images'
        roidb = []
    ...
    def append_flipped_images(self, roidb):
        ...
        assert self.num_seqs == len(roidb)
        for i in range(self.num_seqs):
            roi_rec = roidb[i]
    ...
    def evaluate_recall(self, roidb, candidate_boxes=None, thresholds=None):
        ...
        print 'average number of proposal', total_counts / self.num_seqs
